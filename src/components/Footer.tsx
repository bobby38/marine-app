...
const Footer: React.FC = () => {
  return (
    <footer className="bg-white dark:bg-gray-800 border-t dark:border-gray-700 w-full">
      <div className="px-4 sm:px-6 lg:px-8 py-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div className="space-y-4">
            <h3 className="text-white dark:text-gray-300 text-lg font-semibold">Marine Services</h3>
            <p className="text-sm dark:text-gray-400">
              Connecting boat owners with trusted marine service providers since 2023
            </p>
            <div className="flex space-x-4">
              <a href="#" className="hover:text-white dark:hover:text-gray-300">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-white dark:text-gray-300 text-lg font-semibold mb-4">Quick Links</h3>
            <ul className="space-y-2">
              <li><Link to="/" className="hover:text-white dark:hover:text-gray-300">Home</Link></li>
              <li><Link to="/services" className="hover:text-white dark:hover:text-gray-300">Services</Link></li>
              <li><Link to="/about" className="hover:text-white dark:hover:text-gray-300">About Us</Link></li>
              <li><Link to="/contact" className="hover:text-white dark:hover:text-gray-300">Contact</Link></li>
            </ul>
          </div>

          {/* For Providers */}
          <div>
            <h3 className="text-white dark:text-gray-300 text-lg font-semibold mb-4">For Providers</h3>
            <ul className="space-y-2">
          ...
          {/* For Users */}
          <div>
            <h3 className="text-white dark:text-gray-300 text-lg font-semibold mb-4">For Users</h3>
            <ul className="space-y-2">
